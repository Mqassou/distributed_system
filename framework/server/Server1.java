...
public class Server1 {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Server1: running on host " + InetAddress.getLocalHost());
		System.out.println("Server1: hostname property " + System.getProperty("java.rmi.server.hostname"));
		...
		System.out.println("Server1: registered remote object's stub");
