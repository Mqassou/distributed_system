...
public class Server3 {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Server3: running on host " + InetAddress.getLocalHost());
		System.out.println("Server3: hostname property " + System.getProperty("java.rmi.server.hostname"));
		...
		System.out.println("Server3: registered remote object's stub");
